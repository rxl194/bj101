...
angular.module('cbo_articles').controller('cboArticlesController', ['$scope', '$routeParams', '$location', 'Authentication', 'cboArticles',
    function($scope, $routeParams, $location, Authentication, Articles) {
        ...
        $scope.create = function() {
            ...
            article.$save(function(response) {
                ...
                $location.path('bo/articles/' + response._id);
