...
angular.module('angularjs01P2_appapp')
.factory("angularjs01P2SharedWorkoutService", 
          ['Angularjs01P2WorkoutPlan', 'Angularjs01P2Exercise', 
  function (Angularjs01P2WorkoutPlan,   Angularjs01P2Exercise) {
  ...
  var setupInitialWorkouts = function () {
    ...
    var workout = new Angularjs01P2WorkoutPlan({
      name: "7minWorkout",
